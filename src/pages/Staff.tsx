            ...
            >
                <table className="w-full text-sm text-left rtl:text-right text-black">
                    ...
                    <tr className="hover:bg-slate-200 border-b border-gray-950 font-bold">
                        <td className="px-6 py-4">Shyamantha Perera</td>
                        <td className="px-6 py-4">Manager</td>
                        <td className="px-6 py-4">Male</td>
                        <td className="px-6 py-4">2025-01-20</td>
                        <td className="px-6 py-4">1998-12-01</td>
                        <td className="px-6 py-4">Bandaragama</td>
                        <td className="px-6 py-4">0717085277</td>
                        <td className="px-6 py-4">shyamanthaperer64@gmail.com</td>
                        <td className="px-6 py-4">Manager</td>
